...
/**
 ...
 @see The chapter <a href="http://homepage.sunrise.ch/mysunrise/peterfleury/avr-lcd44780.html" target="_blank">Interfacing a HD44780 Based LCD to an AVR</a>
      on my home page.
 @note Modifyed by ARV: added some options for output fuctions.
*/

/// Если этот макрос НЕ НОЛЬ, то функции вывода на индикатор возвращают количество выведенных символов 
#define VOID_OUTPUT_FUNC 0
