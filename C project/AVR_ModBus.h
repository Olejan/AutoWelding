...
#define UCSRC_SET() UCSRC = 1 << URSEL | 1 << UCSZ0 | 1 << UCSZ1 //8bit, None, 1stop.bit
...
#define QUANTITY_REG_4X 9/*6*/ //количество аналоговых выходов (AO) r0x03, w0x06, w0x10(16)

//запуск таймера0 для контроля паузы 3,5символа
// При F_CLK = 4MHz, baud = 9600 => t3_5 = 3,6458ms, предделитель = 64, TCNT0 = 0x1c
#define StartTimer0() TCCR0 = 1 << CS00 | 1 << CS01;  TCNT0 = 0x1C;//130;
